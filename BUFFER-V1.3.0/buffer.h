...
~ Changes	 :
				- Add 	  : BufferTypeDef structure for create buffer.
...
uint8_t Buffer_Compare( Buffer_TypeDef *ubuffer,uint8_t *udata); /* Function for compare string with data buffer */
/*
	Guide   :
			 Parameters    :
							ubuffer : Pointer to user buffer.
	...
	Example :
				...
				Buffer_Compare(&usart_buffer , "HELLO");
